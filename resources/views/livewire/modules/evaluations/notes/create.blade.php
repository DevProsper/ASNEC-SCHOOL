<div class="row p-4 pt-5">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input required wire:model="rows.{{ $index }}.noteDevoir2" type="text"
                                    class="form-control @error('nom') is-invalid @enderror">
                            </div>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input required wire:model="rows.{{ $index }}.noteDevoir3" type="text"
                                    class="form-control @error('nom') is-invalid @enderror">
                            </div>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <label for="noteExamen_{{ $index }}">Note Examen :</label>
                                <input required wire:model="rows.{{ $index }}.noteExamen" type="text"
                                    class="form-control @error('nom') is-invalid @enderror">
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select required wire:model="rows.{{ $index }}.type" 
                                id="type_{{ $index }}" class="form-control">
                                    <option value="">----- </option>
            ...
            <button type="button" wire:click.prevent="goToListEvaluation()" 
            class="btn btn-danger">Retouner à la
                liste des
                élèves</button>
            </div>
        </div>
