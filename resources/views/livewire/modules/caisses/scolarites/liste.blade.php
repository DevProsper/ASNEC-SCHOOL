    ...
    <div class="col-12">
        <div class="callout callout-info">
          <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" wire:model="anneeScolaire">
                            ...
                            <option value="{{ $anneeScolaire->id }}" 
                                @if($anneeScolaire->id === $anneeScolaireParDefaut) selected @endif>
                                {{ $anneeScolaire->nom }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Filtrer par type d'admission</label>
                        <select class="form-control" wire:model="categorieTarificationId">
                            <option value="">Les deux</option>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <!---Si l'id de l'année scolaire et le même que celui de l'année
